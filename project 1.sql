...
CREATE TABLE DEPARTMENT (
    ...
    FOREIGN KEY (DEPARTMENTID) REFERENCES STUDENT(STUDENTID)
);
 ...
 CREATE TABLE TEACHER (
    ...
    DIRECTOR VARCHAR(50),
    DIRECTORID INT,
    FOREIGN KEY(DIRECTORID) REFERENCES DEPARTMENT(DIRECTORID)
);
...
INSERT INTO TEACHER (TEACHERID, FIRSTNAME, MIDDLEINITIAL, LASTNAME, DIRECTOR) VALUES
(1, 'John', 'D', 'Doe', 'JAMES'),
(2, 'Alice', 'M', 'Smith', 'TOM'),
(3, 'Michael', 'J', 'Johnson', 'BILL'),
(4, 'Emily', 'R', 'Roberts', 'HAMID'); 
